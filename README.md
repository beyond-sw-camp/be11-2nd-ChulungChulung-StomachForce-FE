...
| 배타락을 통한 동시성 이슈 처리       | 예약 생성 시, 동시에 여러 요청이 들어와 **중복 예약**이 발생할 수 있는 상황을 방지하기 위해, 레포지토리 레벨에서 **배타락(Lock)**을 적용하였습니다. 이를 통해 데이터 무결성을 확보하고 안정적인 예약 시스템을 구축하였습니다. |
| 다양한 로그인 방식 도입             | 사용자 편의성을 높이기 위해 **자체 회원가입/로그인** 기능 외에도, **구글 OAuth2 로그인**을 도입하였습니다. 이를 통해 다양한 사용자층의 접근성을 높이고, 빠른 회원가입 및 로그인 경험을 제공합니다. |
