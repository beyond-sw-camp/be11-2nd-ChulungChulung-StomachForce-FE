      ...
      <v-card class="pa-5">
        ...
        <v-card-text>
          ...
          >
            ...
            <v-date-picker v-model="announcement.endDate" @update:modelValue="formatEndDate"></v-date-picker>
          </v-menu>
    ...
    methods: {
      async submitAnnouncement() {
        try {
          ...
          formData.append("type", this.announcement.type === "공지" ? "ANNOUNCE" : "EVENT");
